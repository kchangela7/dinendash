...
class _OrderViewState extends State<OrderView> {
  Stream<Map<String, dynamic>> _currentOrder = (() async* {
    Map<String, dynamic> data = {
      "order": [
        {"item": "Burger", "price": 10.55, "quantity": 1},
        {"item": "Curry", "price": 12.97, "quantity": 1},
        {"item": "Chicken Alfredo", "price": 11.29, "quantity": 1},
        {"item": "Large Fries", "price": 5.32, "quantity": 2},
        {"item": "Ice Cream", "price": 3.98, "quantity": 3},
        {"item": "Chicken Burger", "price": 9.64, "quantity": 1}
      ],
